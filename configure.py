...
scylla_core = (['message/messaging_service.cc',
                ...
                'utils/s3/client_helpers/copy_s3_object.cc',
                'utils/s3/client_helpers/do_upload_file.cc',
                'utils/s3/client_helpers/multipart_upload.cc',
                'utils/s3/client_helpers/readable_file.cc',
                'utils/s3/client_helpers/upload_jumbo_sink.cc',
                'utils/s3/client_helpers/upload_sink.cc',
                'utils/s3/client_helpers/upload_sink_base.cc',
