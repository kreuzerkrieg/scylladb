...
using registry_fsp = class_registrator<dht::i_partitioner, fixed_shard_partitioner>;
static registry_fsp registrator_fsp(fixed_shard_partitioner::classname);
static registry_fsp registrator_fsp_short_name("FixedShardPartitioner");
