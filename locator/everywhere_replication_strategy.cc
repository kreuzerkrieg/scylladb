...
using registry_ers = class_registrator<abstract_replication_strategy, everywhere_replication_strategy, replication_strategy_params, const locator::topology*>;
static registry_ers registrator_ers("org.apache.cassandra.locator.EverywhereStrategy");
static registry_ers registrator_ers_short_name("EverywhereStrategy");
}
