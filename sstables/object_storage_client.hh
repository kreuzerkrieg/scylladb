...
shared_ptr<object_storage_client> make_object_storage_client(const db::object_storage_endpoint_param&, semaphore&, shard_client_factory, double s3_connections_per_share = s3::endpoint_config::default_connections_per_share);
