...
std::function<uint16_t(void)> get_port = [] { return std::stoi(tests::getenv_safe("MOCK_S3_SERVER_PORT")); };
std::function<std::string(void)> get_address = [] { return tests::getenv_safe("MOCK_S3_SERVER_HOST"); };
