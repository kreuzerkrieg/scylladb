    ...
    async with new_test_keyspace(
        ...
        try:
            ...
            await asyncio.wait_for(
                migration_task,
                timeout=scale_timeout(NUM_MIGRATIONS * 4 + 15 if tablet_storage else NUM_MIGRATIONS * 2 + 15),
                # 20*2+15 = 55s before scaling or 95s in case of object storage since it is much slower
            )
