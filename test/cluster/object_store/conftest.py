...
async def make_object_storage(kind, pytestconfig, tmpdir, test_name, manager: ManagerClient):
    ...
    try:
        ...
        # The manager refuses the registration rather than half-applying it,
        # so the callback will not fire.  No node has been told about the
        # bucket yet either, so destroying it here races with nothing.
