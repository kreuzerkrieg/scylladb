...
public:
    ...
    // Sizes the retry budget for the number of requests that can be in flight.
    // Called again whenever that number is reconfigured.
    virtual void resize_retry_quota(unsigned connections_per_shard) = 0;
